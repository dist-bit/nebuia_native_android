...
public class ProgressAnimatedView extends View {
    private RectF oval;
    ...
    public ProgressAnimatedView(Context context) {
        super(context);
        init(context);
    }

    public ProgressAnimatedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ProgressAnimatedView(Context context, AttributeSet attrs, int defStyleAttr) {
