...
public class RadialGradientLayer extends ImageView {
    public RadialGradientLayer(Context context) {
        this(context, null);
    }

    public RadialGradientLayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
